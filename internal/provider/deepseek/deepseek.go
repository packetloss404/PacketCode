...
//
// DeepSeek's protocol is identical to OpenAI's at the wire level, so this
// package is a thin shell over openaicompat.Client with DeepSeek-specific
...
var brandColor = lipgloss.Color("#4D6BFE")
...
// ListModels asks the upstream catalog first; if DeepSeek responds with an
