...
// models/pricing docs in July 2026.
var pricingTable = map[string]pricingEntry{
	"claude-fable-5":            {Input: 10.00, Output: 50.00, ContextWindow: 1_000_000, MaxOutput: 128_000, SupportsTools: true},
	"claude-opus-4-8":           {Input: 5.00, Output: 25.00, ContextWindow: 1_000_000, MaxOutput: 128_000, SupportsTools: true},
	...
	"claude-sonnet-5":           {Input: 3.00, Output: 15.00, ContextWindow: 1_000_000, MaxOutput: 128_000, SupportsTools: true},
	"claude-sonnet-4-6":         {Input: 3.00, Output: 15.00, ContextWindow: 1_000_000, MaxOutput: 128_000, SupportsTools: true},
