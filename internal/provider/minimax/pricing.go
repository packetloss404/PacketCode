...
var pricingTable = map[string]pricingEntry{
	"MiniMax-Text-01":      {Input: 0.20, Output: 1.10, ContextWindow: 1_000_000},
	"abab6.5s-chat":        {Input: 1.00, Output: 1.00, ContextWindow: 245_000},
	"abab6.5-chat":         {Input: 5.00, Output: 5.00, ContextWindow: 245_000},
}
